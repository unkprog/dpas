...
namespace dpas.Core.Extensions
{
    ...
    {
        public static object GetValue(this IDictionary<string, object> aValues, string aParam)
        {
            object result = null;
        ...
        public static DateTime GetDateTime(this IDictionary<string, object> aValues, string aParam)
        {
    ...
    {
        public static string GetString(this IDictionary<string, string> aValues, string aParam, string aDefault = "")
        {
        ...
        public static bool GetBool(this IDictionary<string, string> aValues, string aParam, bool aDefault = false)
        {
            return TryParse.Bool(aValues.GetString(aParam), aDefault);
        }

        public static DateTime GetDateTime(this IDictionary<string, string> aValues, string aParam)
        {
            return GetDateTime(aValues, aParam, TryParse.MinDate);
        }

        public static DateTime GetDateTime(this IDictionary<string, string> aValues, string aParam, DateTime aDefault)
        {
